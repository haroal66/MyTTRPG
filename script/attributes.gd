...
func _on_level_text_submitted(_new_text: String) -> void:
	update_point_remaining()
...
func _on_intellect_text_submitted(new_text: String) -> void:
	intellect = utils.get_num(new_text)
	update_point_remaining()

func _on_willpower_text_submitted(new_text: String) -> void:
	willpower = utils.get_num(new_text)
	update_point_remaining()

func _on_awareness_text_submitted(new_text: String) -> void:
